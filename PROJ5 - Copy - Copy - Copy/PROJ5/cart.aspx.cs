...
namespace PROJ5
{
    public partial class cart : System.Web.UI.Page
    {
        ...
        protected void RenderCart()
        {
            ...
            SqlCommand com1 = new SqlCommand($"select product.product_name , product.product_PICTURE , product.prodct_price , cart.product_quantity ,cart.cart_id , cart.product_id from cart inner join product on product.product_id = cart.product_id where Userid = 3", CONN);
